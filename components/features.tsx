      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20 border-t border-gray-800">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 mb-4">Composite Filament Winding and CNC Machining Services</h2>
            <p className="text-xl text-gray-400">Delivering top-quality services for your composite manufacturing needs.</p>
          </div>
          ...
          <div className="max-w-sm mx-auto grid gap-8 md:grid-cols-2 lg:grid-cols-3 lg:gap-16 items-start md:max-w-2xl lg:max-w-none" data-aos-id-blocks>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-anchor="[data-aos-id-blocks]">
              ...
              <h4 className="h4 mb-2 text-center">Composite Filament Winding</h4>
              <p className="text-lg text-gray-400 text-center">Precision winding of composite materials, including glass fiber, carbon fiber, and epoxy.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="100" data-aos-anchor="[data-aos-id-blocks]">
              ...
              <h4 className="h4 mb-2 text-center">CNC Turning</h4>
              <p className="text-lg text-gray-400 text-center">High-precision CNC turning services for custom components.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="200" data-aos-anchor="[data-aos-id-blocks]">
              ...
              <h4 className="h4 mb-2 text-center">Advanced CNC Machining</h4>
              <p className="text-lg text-gray-400 text-center">Utilizing cutting-edge CNC technology for precise and efficient machining.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="300" data-aos-anchor="[data-aos-id-blocks]">
              ...
              <h4 className="h4 mb-2 text-center">Efficient CNC Machining Processes</h4>
              <p className="text-lg text-gray-400 text-center">Streamlined CNC machining processes for rapid production.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="400" data-aos-anchor="[data-aos-id-blocks]">
              ...
              <h4 className="h4 mb-2 text-center">Fast Turnaround</h4>
              <p className="text-lg text-gray-400 text-center">Quick CNC machining services to meet tight deadlines.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="500" data-aos-anchor="[data-aos-id-blocks]">
              ...
              <h4 className="h4 mb-2 text-center">Reliable CNC Services</h4>
              <p className="text-lg text-gray-400 text-center">Dependable CNC machining solutions for your manufacturing needs.</p>
            </div>
